...
class FA2_mint(FA2_core):
    ...
    def mint(self, params):
        ...
        if self.config.non_fungible:
            # # Removed both checks from here to mint the same one again in case 
            # the ditions ran out and amount can be more than one while minting.
